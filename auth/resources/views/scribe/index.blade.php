    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-login">Authentication.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-POSTapi-register">
                                <a href="#authentication-POSTapi-register">Register
Регистрация</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="authentication-GETapi-me">
                                <a href="#authentication-GETapi-me">User profile information
Информация о профиле</a>
                            </li>
...
<p>This API is not authenticated.</p>
        ...
        <h1 id="authentication">Authentication</h1>
                                ...
                                <h2 id="authentication-POSTapi-login">Authentication.</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body" hidden>
    <br>
<p>Пароль ползователя</p>
        </p>
        </form>

                    <h2 id="authentication-POSTapi-register">Register
Регистрация</h2>
...
<small>string</small>&nbsp;
 &nbsp;
               ...
               data-component="body" hidden>
    <br>
<p>Имя пользователя. Пример: &quot;John Doe&quot;</p>
        </p>
                <p>
            <b><code>email</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
...
<p>пароль пользователя.</p>
                ...
                <p>
            <b><code>password_confirmation</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 &nbsp;
                <input type="text"
               ...
               data-component="body" hidden>
    <br>
<p>подтверждение пользователя.</p>
        </p>
        </form>

                    <h2 id="authentication-GETapi-me">User profile information
Информация о профиле</h2>
